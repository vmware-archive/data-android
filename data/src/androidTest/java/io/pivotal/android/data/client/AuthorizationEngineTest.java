...
public class AuthorizationEngineTest extends AbstractAuthorizedClientTest<AuthorizationEngine> {
    ...
    public void testSetParametersRequiresNotNullClientId() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters(null, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testSetParametersRequiresNotEmptyClientId() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters("", TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testSetParametersRequiresNotNullClientSecret() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters(TEST_CLIENT_ID, null, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testSetParametersRequiresNotEmptyClientSecret() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters(TEST_CLIENT_ID, "", TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testSetParametersRequiresAuthorizationUrl() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, null, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testSetParametersRequiresNotNullRedirectUrl() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, null, TEST_DATA_SERVICES_URL));
    }

    public void testSetParametersRequiresNotEmptyRedirectUrl() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, "", TEST_DATA_SERVICES_URL));
    }

    public void testSetParametersRequiresDataServices() throws Exception {
        baseTestSetParametersRequires(new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, null));
    }
    ...
    public void testChangingClientIdWillClearCredentials() throws Exception {
        getEngine().setParameters(parameters);
        saveCredential();
        final DataStoreParameters modifiedParameters = new DataStoreParameters(TEST_CLIENT_ID_2, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL);
    ...
    public void testChangingClientSecretWillClearCredentials() throws Exception {
        getEngine().setParameters(parameters);
        saveCredential();
        final DataStoreParameters modifiedParameters = new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET_2, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL);
        getEngine().setParameters(modifiedParameters);
        assertCredentialEquals(null, apiProvider);
    }
    ...
    public void testChangingAuthorizationUrlWillClearCredentials() throws Exception {
        getEngine().setParameters(parameters);
        saveCredential();
        final DataStoreParameters modifiedParameters = new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL_2, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL);
        getEngine().setParameters(modifiedParameters);
        assertCredentialEquals(null, apiProvider);
    }
    ...
    public void testChangingRedirectUrlWillClearCredentials() throws Exception {
        getEngine().setParameters(parameters);
        saveCredential();
        final DataStoreParameters modifiedParameters = new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL_2, TEST_DATA_SERVICES_URL);
        getEngine().setParameters(modifiedParameters);
        assertCredentialEquals(null, apiProvider);
    }
    ...
    public void testChangingDataServicesUrlDoesNotClearCredentials() throws Exception {
        getEngine().setParameters(parameters);
        saveCredential();
        final DataStoreParameters modifiedParameters = new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL_2);
        getEngine().setParameters(modifiedParameters);
        assertCredentialEquals(credential, apiProvider);
    }
    ...
    public void testObtainAuthorizationRequiresNotNullClientId() throws Exception {
        baseTestObtainAuthorizationRequires(activity, new DataStoreParameters(null, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testObtainAuthorizationRequiresNotEmptyClientId() throws Exception {
        baseTestObtainAuthorizationRequires(activity, new DataStoreParameters("", TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testObtainAuthorizationRequiresNotNullClientSecret() throws Exception {
        baseTestObtainAuthorizationRequires(activity, new DataStoreParameters(TEST_CLIENT_SECRET, null, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }
    ...
    public void testObtainAuthorizationRequiresAuthorizationUrl() throws Exception {
        baseTestObtainAuthorizationRequires(activity, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, null, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testObtainAuthorizationRequiresNotNullRedirectUrl() throws Exception {
        baseTestObtainAuthorizationRequires(activity, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, null, TEST_DATA_SERVICES_URL));
    }

    public void testObtainAuthorizationRequiresNotEmptyRedirectUrl() throws Exception {
        baseTestObtainAuthorizationRequires(activity, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, "", TEST_DATA_SERVICES_URL));
    }

    public void testObtainAuthorizationRequiresDataServicesUrl() throws Exception {
        baseTestObtainAuthorizationRequires(activity, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, null));
    }
    ...
    public void testAuthorizationCodeReceivedRequiresNotNullClientId() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters(null, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testAuthorizationCodeReceivedRequiresNotEmptyClientId() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters("", TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testAuthorizationCodeReceivedRequiresNotNullClientSecret() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters(TEST_CLIENT_ID, null, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testAuthorizationCodeReceivedRequiresNotEmptyClientSecret() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters(TEST_CLIENT_ID, "", TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testAuthorizationCodeReceivedRequiresAuthorizationUrl() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, null, TEST_REDIRECT_URL, TEST_DATA_SERVICES_URL));
    }

    public void testAuthorizationCodeReceivedRequiresNotNullRedirectUrl() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, null, TEST_DATA_SERVICES_URL));
    }

    public void testAuthorizationCodeReceivedRequiresNotEmptyRedirectUrl() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, "", TEST_DATA_SERVICES_URL));
    }

    public void testAuthorizationCodeReceivedRequiresDataServicesUrl() throws Exception {
        baseTestAuthorizationCodeReceivedRequires(authorizationActivity, TEST_AUTHORIZATION_CODE, new DataStoreParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_REDIRECT_URL, null));
    }
