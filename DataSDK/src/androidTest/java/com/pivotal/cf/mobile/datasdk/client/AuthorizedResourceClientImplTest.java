...
public class AuthorizedResourceClientImplTest extends AbstractAuthorizedClientTest<AuthorizedResourceClientImpl> {
    ...
    public void testObtainAuthorizationRequiresNotNullClientId() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters(null, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_TOKEN_URL, TEST_REDIRECT_URL), listener);
    }

    public void testObtainAuthorizationRequiresNotEmptyClientId() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters("", TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_TOKEN_URL, TEST_REDIRECT_URL), listener);
    }

    public void testObtainAuthorizationRequiresNotNullClientSecret() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters(TEST_CLIENT_ID, null, TEST_AUTHORIZATION_URL, TEST_TOKEN_URL, TEST_REDIRECT_URL), listener);
    }

    public void testObtainAuthorizationRequiresNotEmptyClientSecret() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters(TEST_CLIENT_ID, "", TEST_AUTHORIZATION_URL, TEST_TOKEN_URL, TEST_REDIRECT_URL), listener);
    }

    public void testObtainAuthorizationRequiresAuthorizationUrl() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, null, TEST_TOKEN_URL, TEST_REDIRECT_URL), listener);
    }

    public void testObtainAuthorizationRequiresTokenUrl() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, null, TEST_REDIRECT_URL), listener);
    }

    public void testObtainAuthorizationRequiresNotNullRedirectUrl() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_TOKEN_URL, null), listener);
    }

    public void testObtainAuthorizationRequiresNotEmptyRedirectUrl() throws Exception {
        baseTestRequires(HTTP_GET, url, headers, TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING, new DataParameters(TEST_CLIENT_ID, TEST_CLIENT_SECRET, TEST_AUTHORIZATION_URL, TEST_TOKEN_URL, ""), listener);
    }
